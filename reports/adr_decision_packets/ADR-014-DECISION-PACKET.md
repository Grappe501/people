...
Should **ADR-014** be accepted as the governing Decision Log decision for **Idempotency**?

If accepting the IS-101 recommendation: Keys + unique constraints + app checks

## 3. Background

- Why open: IS-101 recommendation recorded; Decision Log acceptance never completed.
- Why it matters: CON-UNQ-PROMO-IDEMPOTENCY posture
...
- Description: Accept IS-101/IS-303 posture
...
- IS-101 ADR-014; `docs/adr/_index.md`
...
- G-10 effect: CONDITIONAL | MG effect: Promotion/idempotent MG constraints

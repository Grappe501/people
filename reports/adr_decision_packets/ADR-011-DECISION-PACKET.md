...
Should **ADR-011** be accepted as the governing Decision Log decision for **Test Framework**?

If accepting the IS-101 recommendation: Vitest + Playwright class toolchain

## 3. Background

- Why open: IS-101 recommendation recorded; Decision Log acceptance never completed.
- Why it matters: Test layout
...
- IS-101 ADR-011; `docs/adr/_index.md`
...
- G-10 effect: CONDITIONAL | MG effect: Test packages

...
Should **ADR-010** be accepted as the governing Decision Log decision for **Schema Validation**?

If accepting the IS-101 recommendation: Zod and/or Ajv; contracts authoritative

## 3. Background

- Why open: IS-101 recommendation recorded; Decision Log acceptance never completed.
- Why it matters: Validation toolchain
...
- IS-101 ADR-010; `docs/adr/_index.md`
...
- G-10 effect: CONDITIONAL | MG effect: App validation packages

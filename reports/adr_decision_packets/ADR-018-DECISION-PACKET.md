...
Should **ADR-018** be accepted as the governing Decision Log decision for **Feature Flags**?

If accepting the IS-101 recommendation: Catalog 4 flags first

## 3. Background

- Why open: IS-101 recommendation recorded; Decision Log acceptance never completed.
- Why it matters: Config
...
- IS-101 ADR-018; `docs/adr/_index.md`
...
- G-10 effect: CONDITIONAL | MG effect: Config packages
